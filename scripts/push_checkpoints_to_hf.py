...
EXPERIMENTS = {
    ...
    "p1_a1": {
        ...
        "config": "configs/midflow_qwen_8to11_p1_a1_proj_mixb_endkl.yaml",
    ...
    "p1_a2": {
        ...
        "config": "configs/midflow_qwen_8to11_p1_a2_rrb_mixb_endkl_trainT_r2468.yaml",
    ...
    "p1_a3": {
        ...
        "config": "configs/midflow_qwen_8to11_p1_a3_flow_mixb_endkl_trainT_r2468.yaml",
    ...
    "p2_l1": {
        ...
        "config": "configs/midflow_qwen_8to11_p2_l1_flow_mixb_end_trainT_r2468.yaml",
        "checkpoint": "outputs/midflow_qwen_8to11_p2_l1_flow_mixb_end_trainT_r2468/checkpoints/best.ckpt",
        "architecture": "flow_midblock",
        "train_T": [2, 4, 6, 8],
        "eval_T": [1, 2, 4, 8],
        "wandb_run": "gb55agvq",
    ...
    "p2_l2": {
        ...
        "subdir": "p2_l2_end_kl",
        "config": "configs/midflow_qwen_8to11_p2_l2_flow_mixb_endkl_trainT_r2468.yaml",
        "checkpoint": "outputs/midflow_qwen_8to11_p2_l2_flow_mixb_endkl_trainT_r2468/checkpoints/best.ckpt",
        "architecture": "flow_midblock",
        "train_T": [2, 4, 6, 8],
        "eval_T": [1, 2, 4, 8],
        "wandb_run": "999lvi8w",
    ...
    "p2_l3": {
        ...
        "config": "configs/midflow_qwen_8to11_p2_l3_flow_mixb_endtrajkl_trainT_r2468.yaml",
        "checkpoint": "outputs/midflow_qwen_8to11_p2_l3_flow_mixb_endtrajkl_trainT_r2468/checkpoints/best.ckpt",
        "architecture": "flow_midblock",
        "train_T": [2, 4, 6, 8],
        "eval_T": [1, 2, 4, 8],
        "wandb_run": "3l9gii67",
    ...
    "p2_l4": {
        ...
        "config": "configs/midflow_qwen_8to11_p2_l4_flow_mixb_endtrajklce_trainT_r2468.yaml",
        "checkpoint": "outputs/midflow_qwen_8to11_p2_l4_flow_mixb_endtrajklce_trainT_r2468/checkpoints/best.ckpt",
        "architecture": "flow_midblock",
        "train_T": [2, 4, 6, 8],
        "eval_T": [1, 2, 4, 8],
        "wandb_run": "4cb8comp",
    ...
    "p3_d1": {
        ...
        "subdir": "p3_d1_mix_a",
        "config": "configs/midflow_qwen_8to11_p3_d1_flow_mixa_endtrajkl_trainT_r2468.yaml",
        "checkpoint": "outputs/midflow_qwen_8to11_p3_d1_flow_mixa_endtrajkl_trainT_r2468/checkpoints/best.ckpt",
        "architecture": "flow_midblock",
        "train_T": [2, 4, 6, 8],
        "eval_T": [1, 2, 4, 8],
        "wandb_run": "q66380nm",
    ...
    "p3_d2": {
        ...
        "subdir": "p3_d2_mix_b",
        "config": "configs/midflow_qwen_8to11_p3_d2_flow_mixb_endtrajkl_trainT_r2468.yaml",
        "checkpoint": "outputs/midflow_qwen_8to11_p3_d2_flow_mixb_endtrajkl_trainT_r2468/checkpoints/best.ckpt",
        "architecture": "flow_midblock",
        "train_T": [2, 4, 6, 8],
        "eval_T": [1, 2, 4, 8],
        "wandb_run": None,
    ...
    "p3_d3": {
        ...
        "subdir": "p3_d3_mix_c",
        "config": "configs/midflow_qwen_8to11_p3_d3_flow_mixc_endtrajkl_trainT_r2468.yaml",
        "checkpoint": "outputs/midflow_qwen_8to11_p3_d3_flow_mixc_endtrajkl_trainT_r2468/checkpoints/best.ckpt",
        "architecture": "flow_midblock",
        "train_T": [2, 4, 6, 8],
        "eval_T": [1, 2, 4, 8],
        "wandb_run": None,
    ...
    "p4_e1": {
        ...
        "config": "configs/midflow_qwen_8to11_p4_flow_mixc_endtrajkl_evalT1.yaml",
        "checkpoint": "outputs/midflow_qwen_8to11_p4_flow_mixc_endtrajkl_evalT1/checkpoints/best.ckpt",
        "architecture": "flow_midblock",
        "train_T": [2, 4, 6, 8],
        "eval_T": [1],
        "wandb_run": None,
    ...
    "p4_e2": {
        ...
        "config": "configs/midflow_qwen_8to11_p4_flow_mixc_endtrajkl_evalT2.yaml",
        "checkpoint": "outputs/midflow_qwen_8to11_p4_flow_mixc_endtrajkl_evalT2/checkpoints/best.ckpt",
        "architecture": "flow_midblock",
        "train_T": [2, 4, 6, 8],
        "eval_T": [2],
        "wandb_run": None,
    ...
    "p4_e3": {
        ...
        "config": "configs/midflow_qwen_8to11_p4_flow_mixc_endtrajkl_evalT4.yaml",
        "checkpoint": "outputs/midflow_qwen_8to11_p4_flow_mixc_endtrajkl_evalT4/checkpoints/best.ckpt",
        "architecture": "flow_midblock",
        "train_T": [2, 4, 6, 8],
        "eval_T": [4],
        "wandb_run": None,
    ...
    "p4_e4": {
        ...
        "config": "configs/midflow_qwen_8to11_p4_flow_mixc_endtrajkl_evalT8.yaml",
        "checkpoint": "outputs/midflow_qwen_8to11_p4_flow_mixc_endtrajkl_evalT8/checkpoints/best.ckpt",
        "architecture": "flow_midblock",
        "train_T": [2, 4, 6, 8],
        "eval_T": [8],
        "wandb_run": None,
    ...
    "p4_e5": {
        ...
        "config": "configs/midflow_qwen_8to11_p4_flow_mixc_endtrajkl_evalT12.yaml",
        "checkpoint": "outputs/midflow_qwen_8to11_p4_flow_mixc_endtrajkl_evalT12/checkpoints/best.ckpt",
        "architecture": "flow_midblock",
        "train_T": [2, 4, 6, 8],
        "eval_T": [12],
        "wandb_run": None,
